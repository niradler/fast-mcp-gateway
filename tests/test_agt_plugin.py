...
def _gateway_context() -> Any:
    ...
    from fast_gateway.plugins import GatewayContext
...
async def test_enforce_hook_denies_disallowed_tool() -> None:
    ...
    from fast_gateway.plugins.agentos.plugin import AgtAgentOsPlugin
    from fast_gateway.plugins.agentos.settings import AgtAgentOsSettings
...
async def test_prompt_injection_hook_denies_injection_args() -> None:
    from fast_gateway.hooks import ToolDecision
    from fast_gateway.plugins.agentos.detectors import make_prompt_injection_hook
    from fast_gateway.plugins.agentos.settings import AgtAgentOsSettings
...
async def test_semantic_policy_hook_denies_with_tuned_config() -> None:
    ...
    from fast_gateway.hooks import ToolDecision
    from fast_gateway.plugins.agentos.detectors import make_semantic_policy_hook
    from fast_gateway.plugins.agentos.settings import AgtAgentOsSettings
...
async def test_response_scan_hook_blocks_unsafe_response() -> None:
    ...
    from fast_gateway.plugins.agentos.detectors import make_response_scan_hook
    from fast_gateway.plugins.agentos.settings import AgtAgentOsSettings
...
async def test_credential_redaction_hook_redacts_string() -> None:
    from fast_gateway.plugins.agentos.detectors import make_credential_redaction_hook
    from fast_gateway.plugins.agentos.settings import AgtAgentOsSettings
...
async def test_egress_hook_allows_and_denies_upstreams() -> None:
    ...
    from fast_gateway.plugins.agentos.detectors import make_egress_hook
    from fast_gateway.plugins.agentos.settings import AgtAgentOsSettings
